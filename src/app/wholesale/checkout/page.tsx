...
export default async function WholesaleCheckoutPage() {
  ...
  if (items.length === 0) redirect("/wholesale/cart");
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10 grid md:grid-cols-3 gap-8">
      <div className="md:col-span-2">
        <h1 className="text-2xl font-bold text-stone-900 mb-6">Wholesale checkout</h1>
        <CheckoutForm scope="wholesale" addresses={addresses} />
      </div>
      <div>
